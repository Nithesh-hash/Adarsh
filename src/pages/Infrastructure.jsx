      ...
      <div style={{ textAlign: 'left' }}>
        ...
        <div style={{ margin: '40px 0' }}>
          <div className="gallery-grid" style={{ width: '100%' }}>
            <div style={{ textAlign: 'center', width: '100%', aspectRatio: '4/3' }}>
              <img 
                src="/images/infra1.png" 
                style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '8px', boxShadow: '0 8px 25px rgba(0,0,0,0.1)', display: 'block' }} 
                alt="Adarsh Infrastructure 1" 
              />
            </div>
            <div style={{ textAlign: 'center', width: '100%', aspectRatio: '4/3' }}>
              <img 
